(function () {
	...
	var bonusser = document.querySelector('#bonusgratuit');
	var counter = 10;
	var bonusClick = 0;
	var prixAutoclick = 500;
	var seconds = 30;
	var random = Math.floor((Math.random() * 3000) + 1000)
	var scoreForBobonunusOne = 100;
	var scoreForBobonunusTwo = 300;
	//var cache = document.getElementById("bobonunuss").style.display = "none";
	//var pascache = document.getElementById("bobonunuss").style.display = "block";

	//document.getElementById('bobonunuss').style.visibility = "hidden";
